...
use Webmozart\Assert\Assert; // Import the new base class

class DownloadAttachmentPlaceHolder extends XotBasePlaceholder // Extend the new base class
{protected function setUp(): void
{
    parent::setUp();
    $this->label('')->content($this->generateContent(...))->columnSpanFull(); // Removed the view() call
}
=======
